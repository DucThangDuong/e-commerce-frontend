                ...
                <section className="flex flex-col gap-6">
                  ...
                  <div className="grid grid-cols-1 gap-5">
                    <div className="flex flex-col gap-1.5">
                      ...
                      <input
                        className="w-full rounded-lg border-slate-200 bg-white text-slate-900 focus:ring-1
                                             focus:ring-primary focus:border-primary px-4 py-3 text-sm placeholder:text-slate-400"
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      <input
                        className="w-full rounded-lg border-slate-200 bg-white text-slate-900 focus:ring-1 focus:ring-primary
                         focus:border-primary px-4 py-3 text-sm placeholder:text-slate-400"
