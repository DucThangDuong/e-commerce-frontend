          ...
          <div className="container mx-auto flex items-center justify-center h-full py-8 md:py-12">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 w-full p-6 md:p-10 max-w-[520px]">
              ...
              <div className="mb-8 text-center md:text-left">
                <h1 className="text-2xl font-extrabold text-[#1a1c1b] mb-2 tracking-tight">
                  Tạo tài khoản mới
                </h1>
                <p className="text-[#594138] text-[0.95rem] mb-0">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                <div>
                  <label className="block font-medium text-[0.875rem] mb-1 text-[#1a1c1b]">Tên hiển thị</label>
                  <input 
                    type="text" 
                    value={displayName}
                    onChange={(e) => setDisplayName(e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#a63b00] focus:border-transparent transition-all" 
                ...
                <div>
                  <label className="block font-medium text-[0.875rem] mb-1 text-[#1a1c1b]">Email</label>
                  <input 
                    type="email" 
                    value={email}
                ...
                <div>
                  <label className="block font-medium text-[0.875rem] mb-1 text-[#1a1c1b]">Mật khẩu</label>
                  <div className="relative">
                    <input 
                      type={showPassword ? "text" : "password"} 
                      value={password}
                      onChange={(e) => setPassword(e.target.value)}
                      className="w-full pl-3 pr-10 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#a63b00] focus:border-transparent transition-all" 
                    ...
                    <button 
                      ...
                      className="absolute right-0 top-1/2 -translate-y-1/2 px-3 text-[#594138] hover:text-[#1a1c1b] flex items-center h-full focus:outline-none"
                    >
                ...
                <div>
                  <label className="block font-medium text-[0.875rem] mb-1 text-[#1a1c1b]">Xác nhận mật khẩu</label>
                  <div className="relative">
                    <input 
                ...
                <div className="flex items-start gap-2 mt-2">
                  <input 
                    ...
                    required 
                  />
                  <label htmlFor="terms" className="text-[#594138] select-none text-[0.875rem] cursor-pointer leading-tight">
                    Tôi đồng ý với{' '}
